...
import {ChatSquare, CircleCheck, Delete, EditPen, Female, Male, Plus, Star} from "@element-plus/icons-vue";
        ...
        <div class="topic-main">
            ...
            <div class="topic-main-right">
                ...
                <div style="font-size: 13px;color: grey;text-align: center">
                    <div>{{new Date(topic.data.time).toLocaleString()}}</div>
                </div>
                <div style="text-align: right;margin-top: 20px">
                    <interact-button name="编辑帖子" check-name="已点赞~" color="dodgerblue" :check="false"
...
.topic-main{
    ...
    .topic-main-left{
        ...
        padding: 10px;
        text-align: center;
        border-right: solid 1px var(--el-bg-color);
